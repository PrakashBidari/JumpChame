...
//            System.out.println("points[j]= " + j + " vertices.get(i).x= " + vertices.get(i).x);
//            System.out.println("points[j+1]= " + j+1 + " vertices.get(i).y= " + vertices.get(i).y);
        }

       // System.out.println("interPolygon.area " + vertices.size());
